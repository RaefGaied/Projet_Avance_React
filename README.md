...
### Inscription
![Page d'Inscription](./screenshots/02-register.png)

### Connexion
![Page de Connexion](./screenshots/03-login.png)

### Liste des Cours (Page 1)
![Liste des Cours Page 1](./screenshots/04-courses-page1.png)

### Liste des Cours (Page 2)
![Liste des Cours Page 2](./screenshots/05-courses-page2.png)

### Recherche de Cours
![Recherche de Cours](./screenshots/06-courses-search.png)

### Détails d'un Cours
![Détails d'un Cours](./screenshots/07-course-details.png)

### Ajout d'une Avis
![Ajout d'une Avis](./screenshots/08-add-review.png)

### Mes Avis
![Mes Avis](./screenshots/09-my-reviews.png)

### Mon Profil
![Mon Profil](./screenshots/10-profile.png)

### Édition du Profil
![Édition du Profil](./screenshots/11-edit-profile.png)

### Page 404
![Page 404](./screenshots/12-not-found.png)

### Barre de Navigation (Déconnecté)
![Barre de Navigation Déconnecté](./screenshots/13-navbar-logged-out.png)

### Barre de Navigation (Connecté)
![Barre de Navigation Connecté](./screenshots/14-navbar-logged-in.png)
...
*(Capture d'écran du localStorage non incluse pour des raisons de sécurité)*
...
*(Redirection gérée automatiquement par le système d'authentification)*
...
Voir les captures d'écran dans la section [Liste des Cours](#liste-des-cours-page-1).
...
Voir les captures d'écran dans les sections [Ajout d'une Avis](#ajout-dune-avis) et [Mes Avis](#mes-avis).
...
Voir la capture d'écran dans la section [Édition du Profil](#édition-du-profil).
